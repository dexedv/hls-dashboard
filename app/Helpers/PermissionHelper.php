    ...
    public static function getRolePermissions(string $role): array
    {
        ...
        $roleDefaults = [
            ...
            'manager' => [
                ...
                'tasks.view' => true, 'tasks.create' => true, 'tasks.edit' => true, 'tasks.assign' => true,
                'calendar.view' => true, 'calendar.create' => true, 'calendar.edit' => true,
                'finances.view' => true,
                'invoices.view' => true, 'invoices.create' => true, 'invoices.edit' => true, 'invoices.send' => true,
                'time_tracking.view' => true, 'time_tracking.create' => true, 'time_tracking.approve' => true,
