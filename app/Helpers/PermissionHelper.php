...
class PermissionHelper
{
    ...
    public static function getAllPermissions(): array
    {
        return [
            ...
            'expenses' => [
                'expenses.view' => 'Spesen anzeigen',
                'expenses.create' => 'Spesen erstellen',
                'expenses.edit' => 'Spesen bearbeiten',
                'expenses.delete' => 'Spesen löschen',
                'expenses.approve' => 'Spesen genehmigen',
            ],
            'contracts' => [
                'contracts.view' => 'Verträge anzeigen',
                'contracts.create' => 'Verträge erstellen',
                'contracts.edit' => 'Verträge bearbeiten',
                'contracts.delete' => 'Verträge löschen',
            ],
            'kb' => [
                'kb.view' => 'Wissensdatenbank anzeigen',
    ...
    public static function getRolePermissions(string $role): array
    {
        ...
        $roleDefaults = [
            ...
            'manager' => [
                ...
                'quotes.view' => true, 'quotes.create' => true, 'quotes.edit' => true, 'quotes.export' => true, 'quotes.convert_to_invoice' => true,
                ...
                'kb.view' => true, 'kb.create' => true, 'kb.edit' => true, 'kb.delete' => true,
            ],
            'employee' => [
                'dashboard.view' => true,
                'crm.view' => true,
            ...
            'finance' => [
                ...
                'products.view' => true,
                'expenses.view' => true, 'expenses.approve' => true,
