...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .icon svg { width: 100%; height: 100%; color: #f59e0b; }
...
<body>
    <div class="container">
        ...
        <h1>Serverfehler</h1>
        <p>Es ist ein interner Fehler aufgetreten. Unser Team wurde benachrichtigt. Bitte versuchen Sie es später erneut.</p>
