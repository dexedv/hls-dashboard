...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .icon svg { width: 100%; height: 100%; color: #9ca3af; }
...
<body>
    <div class="container">
        ...
        <p>Die angeforderte Seite existiert nicht oder wurde verschoben. Bitte überprüfen Sie die URL oder kehren Sie zur Startseite zurück.</p>
