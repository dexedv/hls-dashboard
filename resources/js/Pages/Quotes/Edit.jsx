...
export default function Edit() {
    const { quote, customers, projects } = usePage().props;
    ...
    return (
        <DashboardLayout title="Angebot bearbeiten">
            <Head title={`Angebot ${quote.number} bearbeiten`} />
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    value={data.number}
                                    readOnly
                                    className="w-full border border-gray-200 bg-gray-50 rounded-lg px-4 py-2 text-gray-500 cursor-default"
                                />
                            </div>
