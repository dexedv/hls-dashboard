...
export default function TeamIndex({ users, labels }) {
    ...
    const roleLabels = { owner: 'Eigentümer', admin: 'Administrator', manager: 'Manager', employee: 'Mitarbeiter', support: 'Support', finance: 'Finanzen', sales: 'Vertrieb', guest: 'Gast', viewer: 'Betrachter' };
