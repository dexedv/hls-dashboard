    ...
    return (
        <DashboardLayout title="Kunden">
            ...
            <div className="flex gap-1.5 mb-4 flex-wrap">
                {[
                    { value: '',         label: 'Alle' },
                    { value: 'active',   label: 'Aktiv',     color: 'text-green-700 bg-green-50 border-green-200' },
                    { value: 'vip',      label: 'VIP',       color: 'text-violet-700 bg-violet-50 border-violet-200' },
                    { value: 'inactive', label: 'Inaktiv',   color: 'text-gray-600 bg-gray-100 border-gray-200' },
                    { value: 'blocked',  label: 'Gesperrt',  color: 'text-red-700 bg-red-50 border-red-200' },
                ].map(tab => (
