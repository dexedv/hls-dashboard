                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" min="0" value={data.hourly_rate} onChange={e => setData('hourly_rate', e.target.value)}
                        ...
                        <div className="flex items-end pb-1">
                            <label className="flex items-center gap-2 cursor-pointer">
                                ...
                                <span className="text-sm font-medium text-gray-700">Fakturierbar</span>
                            </label>
                        </div>
                        ...
                        <div className="md:col-span-2">
                            ...
                            <textarea value={data.description} onChange={(e) => setData('description', e.target.value)}
                                rows={3} className={`w-full border ${errors.description ? 'border-red-500' : 'border-gray-300'} rounded-lg px-4 py-2 focus:ring-2 focus:ring-primary-500`} />
